...
#### 3.2.5 EvoScientist / Genetic AutoResearch (Lyu et al., 2026)

Applies evolutionary and genetic algorithms to agentic code evolution for research tasks.

#### 3.2.6 AIDE / MLE-STAR / AIRA (Jiang et al., 2025; Nam et al., 2025; Toledo et al., 2025)
